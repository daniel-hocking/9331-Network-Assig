...
filename = sys.argv[3]
max_window_size = int(sys.argv[4]) if num_args >= 5 else 600
max_seg_size = int(sys.argv[5]) if num_args >= 6 else 150
gamma = int(sys.argv[6]) if num_args >= 7 else 4
p_drop = float(sys.argv[7]) if num_args >= 8 else 0.2
...
max_order = int(sys.argv[11]) if num_args >= 12 else 4
p_delay = float(sys.argv[12]) if num_args >= 13 else 0.1
max_delay = int(sys.argv[13]) if num_args >= 14 else 50
